...
int main() {
    vector<string> words{ "camion", "biologie", "oignon", "noisette", "abricot", "ananas", "chien", "chat", "maison", "voiture", "velo", "livre", "arbre", "table", "ordinateur", "stylo", "feuille", "oiseau", "terre", "ciel", "mer", "lac", "montagne", "route", "pont", "fleur", "fruit", "legume", "pomme", "poire", "banane", "orange", "kiwi", "ananas", "raisin", "abricot", "cerise", "noix", "noisette", "amande", "pistache", "avocat", "aubergine", "tomate", "courgette", "poivron", "oignon", "ail", "sel", "poivre", "sucre", "farine", "beurre", "huile", "vinaigre", "moutarde", "pornhub", "portable", "sac", "cafe", "the", "chocolat", "pain", "croissant", "jus", "eau", "bière", "vin", "lait", "fromage", "yaourt", "crème", "miel", "confiture", "nutella", "miel", "mouton", "poulet", "bœuf", "porc", "agneau", "veau", "poisson", "crevette", "huître", "moule", "crabe", "langouste", "ecrevisse", "escalope", "pâtes", "riz", "pizza", "hamburger", "frites", "salade", "sandwich", "steak", "saucisse", "jambon", "bacon", "chorizo", "saumon", "thon", "cabillaud", "epinards", "brocoli", "carotte", "concombre", "radis", "celeri", "persil", "basilic", "thym", "origan", "menthe", "citron", "orange", "mandarine", "pamplemousse", "anis", "cannelle", "gingembre", "curcuma", "cumin", "coriandre", "cardamome", "poivre noir", "paprika", "piment", "ail", "oignon", "echalote", "sel", "poivre", "sucre", "farine", "levure", "œuf", "mayonnaise", "ketchup", "tabasco" };
